...
api.interceptors.request.use(
	// тут на каждый наш запрос на сервер, прикрепи в хэдерс запроса токен авторизации, и запрос уходит вместе с токеном в заголовке (формируется конфиг взаимодействия с сервером)
	config => {
